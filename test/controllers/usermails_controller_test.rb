...
class UsermailsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create usermail" do
    assert_difference('Usermail.count') do
      post usermails_url, params: { usermail: { email: @usermail.email, name: @usermail.name } }
    end
  ...
  test "should update usermail" do
    patch usermail_url(@usermail), params: { usermail: { email: @usermail.email, name: @usermail.name } }
